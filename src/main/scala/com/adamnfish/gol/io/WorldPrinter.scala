...
object WorldPrinter {
  def print(world: World): List[String] =
    print(world, Universe.universeForWorld(world))

  def print(world: World, universe: Universe): List[String] = {
    val content = (universe.minY(world) to universe.maxY(world)).toList map {
      y =>
